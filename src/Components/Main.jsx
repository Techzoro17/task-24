...
const Main = () => {
    ...
    const {total,setTotal,cart,setCart,navigate}=useContext(PaymentContext)
    ...
    <div  className='  m-4 main-h  flex justify-between'>
        ...
        <div className='bg-slate-400 w-5/12 mx-8'>
            <div className=' h-full' >
                ...
                <div className='w-full flex justify-center  '><button className='bg-green-600 w-11/12 p-2 text-white rounded-xl text-xl font-semibold  ' onClick={()=>{navigate('/payment')}}>Proceed to Pay</button></div>
            </div>
        </div>
